...
{
    /// <inheritdoc />
    public partial class Insercion_Boards_BoardMember : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardsMember", x => new { x.UserId, x.BoardId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardsMember_Users_UserId",
                        column: x => x.UserId,
